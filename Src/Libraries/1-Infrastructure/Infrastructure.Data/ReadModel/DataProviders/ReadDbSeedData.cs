    ...
    public static class ReadDbSeedData
    {
        ...
        public static void SyncAdminPanelTempData(IServiceProvider serviceProvider)
        {
            using (var serviceScope = serviceProvider.CreateScope())
            {
                ...
                var _ownerAggregate = _readDbContext.GetCollection<Domain.WriteModel.Workspace.Owners.Entities.Owner>();
                var _boardAggregate = _readDbContext.GetCollection<Domain.WriteModel.Workspace.Boards.Entities.Board>();
                var _taskAggregate = _readDbContext.GetCollection<Domain.WriteModel.Workspace.Tasks.Entities.Task>();
