...
{
    public class MemberAggregateRepository : BaseAggregateRepository<Member>, IMemberAggregateRepository
    {
        #region Fields
        ...
        public MemberAggregateRepository(IMongoDbContext dbContext) : base(dbContext)
        {
