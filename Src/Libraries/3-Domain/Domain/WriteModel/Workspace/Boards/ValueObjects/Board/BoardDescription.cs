    ...
    public class BoardDescription : BaseValueObject
    {
        ...
        protected override void CheckPolicies()
        {
            ...
            if (Value.Length < DomainConstValues.Board_Description_Min_Length)
                throw new DomainException(string.Format(DomainMessages.Length_Error, nameof(BoardName), DomainConstValues.Board_Description_Min_Length, DomainConstValues.Board_Description_Max_Length));
