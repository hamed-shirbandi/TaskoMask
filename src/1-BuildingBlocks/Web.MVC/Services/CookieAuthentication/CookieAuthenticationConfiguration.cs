...
namespace TaskoMask.BuildingBlocks.Web.MVC.Services.Authentication.CookieAuthentication
{
    public static class CookieAuthenticationConfiguration
    {
        ...
        /// 
        /// </summary>
        public static void AddCookieAuthentication(this IServiceCollection services, IWebHostEnvironment env, Action<MVC.Models.CookieAuthenticationOptions> setupAction)
        {
            ...
            var options = services.BuildServiceProvider().GetRequiredService<IOptions<MVC.Models.CookieAuthenticationOptions>>();
