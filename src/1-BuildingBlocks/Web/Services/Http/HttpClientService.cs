...
namespace TaskoMask.BuildingBlocks.Web.Services.Http
{
    ...
    public class HttpClientService : IHttpClientService
    {
        ...
        {
            return await HttpClientRetryHelper.RetryAsync<TResult>(() => _httpClient.PostAsJsonAsync(url, input));
        }
        ...
        {
            return await HttpClientRetryHelper.RetryAsync<TResult>(() => _httpClient.PutAsJsonAsync(url, input));
        }
        ...
        {
            return await HttpClientRetryHelper.RetryAsync<TResult>(() => _httpClient.PutAsJsonAsync(url, new { }));
        }
        ...
        {
            return await HttpClientRetryHelper.RetryAsync<TResult>(() => _httpClient.DeleteAsync(url));
        }
        ...
        {
            return await HttpClientRetryHelper.RetryAsync<TResult>(() => _httpClient.GetAsync(url));
        }
