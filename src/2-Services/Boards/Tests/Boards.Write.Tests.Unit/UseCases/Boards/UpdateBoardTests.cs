...
public class UpdateBoardTests : TestsBaseFixture
{
    ...
    public async Task Board_is_updated()
    {
        ...
        //Act
        var result = await updateBoardUseCase.Handle(updateBoardRequest, CancellationToken.None);
    ...
    public async Task Updatting_a_board_will_throw_an_exception_if_Id_is_not_existed()
    {
        ...
        //Act
        Func<Task> act = async () => await updateBoardUseCase.Handle(updateBoardRequest, CancellationToken.None);
    ...
    public async Task Updating_a_board_will_change_its_version()
    {
        ...
        //Act
        await updateBoardUseCase.Handle(updateBoardRequest, CancellationToken.None);
    ...
    {
        updateBoardUseCase = new UpdateBoardUseCase(BoardAggregateRepository, MessageBus, InMemoryBus, BoardValidatorService);
    }
