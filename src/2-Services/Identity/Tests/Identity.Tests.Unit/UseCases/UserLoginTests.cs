...
public class UserLoginTests : TestsBaseFixture
{
    ...
    public async Task User_is_not_logged_in_with_wrong_password()
    {
        ...
        //Act
        System.Func<Task> act = async () => await userLoginUseCase.Handle(userLoginRequest, CancellationToken.None);
    ...
    {
        userLoginUseCase = new UserLoginUseCase(TestUserManager, TestSignInManager, Mapper);
    }
