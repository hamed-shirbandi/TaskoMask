...
namespace TaskoMask.Services.Owners.Read.Api.Features.Organizations.GetOrganizationsByOwnerId
{
    public class GetOrganizationsByOwnerIdGrpcEndpoint : GetOrganizationsByOwnerIdGrpcService.GetOrganizationsByOwnerIdGrpcServiceBase
    {
        ...
        public override async Task Handle(GetOrganizationsByOwnerIdGrpcRequest request, IServerStreamWriter<GetOrganizationsByOwnerIdGrpcResponse> responseStream, ServerCallContext context)
        {
            ...
            foreach (var organization in organizations.Value)
                await responseStream.WriteAsync(_mapper.Map<GetOrganizationsByOwnerIdGrpcResponse>(organization));
        }
