...
public class DeleteOrganizationTests : TestsBaseFixture
{
    ...
    public async Task Organization_is_deleted()
    {
        ...
        //Act
        var result = await deleteOrganizationUseCase.Handle(deleteOrganizationRequest, CancellationToken.None);
    ...
    public async Task Deleting_an_organization_will_throw_an_exception_if_Id_is_not_existed()
    {
        ...
        //Act
        Func<Task> act = async () => await deleteOrganizationUseCase.Handle(deleteOrganizationRequest, CancellationToken.None);
    ...
    {
        deleteOrganizationUseCase = new DeleteOrganizationUseCase(OwnerAggregateRepository, MessageBus, InMemoryBus);
    }
