...
namespace TaskoMask.Services.Tasks.Write.Tests.Unit.UseCases.Comments
{
    public class DeleteCommentTests : TestsBaseFixture
    {
        ...
        public async Task Comment_is_deleted()
        {
            ...
            //Act
            var result = await _deleteCommentUseCase.Handle(deleteCommentRequest, CancellationToken.None);
        ...
        public async Task Deleting_a_comment_will_throw_an_exception_if_Id_is_not_existed()
        {
            ...
            //Act
            Func<Task> act = async () => await _deleteCommentUseCase.Handle(deleteCommentRequest, CancellationToken.None);
        ...
        {
            _deleteCommentUseCase = new DeleteCommentUseCase(TaskAggregateRepository, MessageBus, InMemoryBus);
        }
