...
using TaskoMask.Services.Tasks.Write.Application.UseCases.Tasks.MoveTaskToAnotherCard;
...
namespace TaskoMask.Services.Tasks.Write.Tests.Unit.UseCases.Tasks
{
    public class MoveTaskToAnotherCardTests : TestsBaseFixture
    {
        ...
        public async Task Task_is_moved_to_another_card()
        {
            ...
            //Act
            var result = await _moveTaskToAnotherCardUseCase.Handle(moveTaskToAnotherCardRequest, CancellationToken.None);
